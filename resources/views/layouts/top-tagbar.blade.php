                        ...
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            <button type="button"
                                ...
                                @switch(Session::get('lang'))
                                    @case('ru')
                                        <img src="{{ URL::asset('images/flags/russia.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
                                        <span id="lang-name">русский</span>
                                    @break

                                    @case('it')
                                        <img src="{{ URL::asset('images/flags/italy.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
                                        <span id="lang-name">Italiana</span>
                                    @break

                                    @case('sp')
                                        <img src="{{ URL::asset('images/flags/spain.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
                                        <span id="lang-name">Española</span>
                                    @break

                                    @case('ch')
                                        <img src="{{ URL::asset('images/flags/china.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
                                        <span id="lang-name">中国人</span>
                                    @break

                                    @case('fr')
                                        <img src="{{ URL::asset('images/flags/french.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
                                        <span id="lang-name">français</span>
                                    @break

                                    @case('gr')
                                        <img src="{{ URL::asset('images/flags/germany.svg') }}"
                                            class="rounded-circle me-2" alt="Header Language" height="16">
