            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-4 col-9">
                    <div class="fs-14 fw-medium">
                        <i class="bi bi-geo-alt align-middle me-2"></i> Abdullah Al Salem
                    </div>
                </div>
                <div class="col-md-4 col-6 d-none d-xxl-block">
                    <div class="d-flex align-items-center justify-content-center gap-3 fs-14 fw-medium">
                        <div>
                            <i class="bi bi-envelope align-middle me-2"></i> support@thehappybash.com
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-3">
                    <div class="d-flex align-items-center justify-content-end gap-3 fs-14">
                        <div class="text-reset fw-normal d-none d-lg-block">
                            <i class="bi bi-telephone-outbound align-middle me-2"></i> +(965) 01234 5678
                        </div>
                        ...
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            <button type="button"
                                ...
                                @switch(Session::get('lang'))
                                    ...
                                    @case('kw')
                                        <img src="{{ URL::asset('build/images/flags/kw.svg') }}" class="rounded-circle me-2"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- item-->
                                <a href="{{ url('index/kw') }}" class="dropdown-item notify-item language"
                                    data-lang="ae" title="Arabic">
                                    <img src="{{ URL::asset('build/images/flags/kw.svg') }}" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
