                    ...
                    <div class="col-2">
                        <a class="navbar-brand mb-2 mb-sm-0" href="index">
                            <img src="{{ URL::asset('build/images/hb-logo.png') }}" class="card-logo card-logo-dark"
                                alt="logo dark" height="82">
                            <img src="{{ URL::asset('build/images/hb-logo.png') }}"
                                class="card-logo card-logo-light" alt="logo light" height="82">
                        </a>
                    </div>
                    <!---end col-->
                    <div class="col-auto">
                        <ul class="list-unstyled hstack gap-2 mb-0">
                            <li class="me-md-3">
                                <a href="#!" class="text-body fw-medium fs-15">Become a Seller</a>
                            </li>
